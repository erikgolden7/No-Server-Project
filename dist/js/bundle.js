...
angular.module('smartApp', ['ui.router']).config(function ($stateProvider, $urlRouterProvider) {
...
angular.module('smartApp').controller('aboutCtrl', function ($scope, $http, mainService) {

	window.scrollTo(0, 0);
});
'use strict';

angular.module('smartApp').controller('contactCtrl', function ($scope, mainService) {

	window.scrollTo(0, 0);
});
'use strict';

angular.module('smartApp').controller('homeCtrl', function ($scope, mainService) {
...
angular.module('smartApp').controller('productsCtrl', function ($scope, productService) {
...
angular.module('smartApp').controller('servicesCtrl', function ($scope, $http, mainService) {

	window.scrollTo(0, 0);
});
'use strict';

angular.module('smartApp').directive('directive', function () {
...
angular.module('smartApp').service('mainService', function ($http) {
...
angular.module('smartApp').service('productService', function ($http) {
